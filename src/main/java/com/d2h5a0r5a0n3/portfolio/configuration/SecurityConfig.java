    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(UrlApiUtil.API_RESUME,UrlApiUtil.API_RESUMES).permitAll()
                        .requestMatchers(HttpMethod.POST, UrlApiUtil.API_RESUME_UPLOAD).permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, UrlApiUtil.API_GET_PROFICIENCIES,UrlApiUtil.API_GET_JOB_TYPE,UrlApiUtil.API_GET_SKILL_ACTIONS,UrlApiUtil.API_GET_SKILL_CATEGORY).hasRole(UrlApiUtil.API_ADMIN)
